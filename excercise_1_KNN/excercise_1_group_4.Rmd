...
ks <- c(9,29,39,49,59,69,79,89,99,109,119,129,139,149,159,169)
# ks <- 1:40
...
for (k_now in ks ){
  ...
  for (i in 1:10) {
    ...
    accuracy_now <- get_accuracy(numbers_test_pred,id_test_labels)
    k_error <- k_error + accuracy_now
...
plot(ks, k_error_avg_vec, type="o", ylab="accuracy")
plot(ks, timing_now_avg_vec, type="o", ylab="average execution time [ms]")
```
