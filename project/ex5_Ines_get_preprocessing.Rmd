...
nn_sizes_check <- c(1, c(1,1), c(1,1,1))
...
for (nn_size in nn_sizes_check){
  ...
  for(i in 1:10){
    ...
    nn <- train_mlp(training_data=train.cv, training_classes=training_class, size=nn_size)
...
mlp_evaluation_data <-data.frame(list(
  'nn_size' = nn_size_list, 
