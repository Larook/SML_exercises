...
get_plots_exc_2_1_all_in <- function(id_dataset){
  set.seed(423)
  ks <- c(35, 75) #, 75) # ks <- c(5,9,13)
...
# basically function does the whole exercise
get_plots_exc_2_1_disjunct <- function(id_dataset){
  set.seed(423)
  ks <- c(35, 75) #, 75) # ks <- c(5,9,13)
  accumulated_variance_v <- c(80)#, 90, 95, 99)
...
get_plots_exc_2_1_disjunct(id_dataset=id)
```
